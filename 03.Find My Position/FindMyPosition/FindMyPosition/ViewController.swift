...
class ViewController: UIViewController,CLLocationManagerDelegate {
    ...
    let locationManager = CLLocationManager() //定位管理

    let geocoder = CLGeocoder() //geocoding地理编码
    ...
    override func viewDidLoad() {
        ...
        let blurView: UIVisualEffectView = UIVisualEffectView(effect: blurEffect) //毛玻璃
